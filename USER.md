...
- **Name:** Carson
- **What to call them:** Carson
- **Username:** ckesplin
- **Timezone:** Mountain Time (MST/MDT, UTC-6/UTC-7)
- **Notes:** Active late at night (past 10 PM local)
- **Discord admin:** Pacolicious (368889178936836102)

## Preferences

- **No emojis** — ever. Plain text only.
- **Stream of thought** — when working through something, send a message after each discrete step. Not batched at the end — real time, as it happens.
- **Questions ≠ execution** — when you ask a question, answer it. If execution is implied, ask for confirmation first.
